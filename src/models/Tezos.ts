...
export type Status = 'NOT BOOTSTRAPED' | 'UNSYNCED' | 'STUCK' | 'ONLINE' | 'WAITING' | 'ERROR'
export type TezosSyncState = 'unsynced' | 'synced' | 'stuck'
// eslint-disable-next-line camelcase
export type IsBootstrapedResponse = { bootstrapped: boolean, sync_state: TezosSyncState }
